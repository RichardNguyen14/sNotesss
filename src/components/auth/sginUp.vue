...
export default {
  ...
  methods: {
    async signUp() {
      ...
      this.isPasswordConfirmationValid = validateConfirmPassword(
  ...
  <div class="form-container sign-up-container">
    <form @submit.prevent="signUp">
      ...
      <input
        ...
        v-model="dataSignUp.password_confirmation"
        @input="validateConfirmPassword"
      />
      <div v-if="!isPasswordConfirmationValid" class="valid">
  ...
  <div v-if="showModalSignUp" class="modal">
    ...
    <div class="modal-content">
      ...
      <div>
        ...
        <button @click="closeModal" class="btn-signup">
          Đóng và Đăng nhập
        </button>
      </div>
    </div>
